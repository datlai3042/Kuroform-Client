                              ...
                              >
                                    <DivNative className={` relative min-h-[3.8rem] h-max flex items-center gap-[.5rem] `}>
                                          <DivNativeRef
                                                ...
                                                }  heading-answer "" placeholder:opacity-90 group min-h-[2rem] pt-[1.2rem] pb-[1.4rem] text-[1.7rem] break-words whitespace-pre-wrap h-max border-b-[.1rem] border-[var(--border-color-input)]  outline-none resize-none `}
