...
const QRDownload = (props: TProps) => {
      ...
      return (
            <div className="w-max  flex flex-col gap-[1.8rem]">
                  ...
                  <Button type="primary" onClick={downloadCanvasQRCode} className=" text-[1.4rem] p-[.4rem_1rem] h-[2.8rem] rounded-[.4rem] bg-color-main">
                     <QrCode />
