      ...
      return (
            <div className="w-[50rem] min-h-[4rem] h-max flex flex-col gap-[1rem]">
                  {Object.keys(temp).map((ipdt, i) =>
                        !ipdt ? (
                              <div className="relative w-full bg-gray-100  rounded-[.4rem_0rem_0rem_.4rem]" key={temp[ipdt].percent + i}>
                                    <div
							...
							`,
                              ...
                              <div className="relative w-full bg-gray-100 rounded-[.4rem]" key={temp[ipdt].percent + i}>
                                    <div
