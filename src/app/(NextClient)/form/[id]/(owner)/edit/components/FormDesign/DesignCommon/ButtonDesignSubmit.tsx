...
const ButtonDesignSubmit = () => {
      ...
      return (
            <button className="text-left">
                  <DivNative className="h-max flex flex-col  justify-between gap-[1.6rem]" onClick={(e) => {}}>
                        <SpanNative textContent={`Nhập content của nút Submit`} onClick={labelClick} className="hover:cursor-pointer" />
                        <DivNativeRef
                              spellCheck={false}
                              ref={contentRef}
