...
const DesignTitleForm = () => {
      ...
      return (
            <div className=" w-full  h-max p-[1rem_0rem] flex flex-wrap gap-[1.2rem]">
                  <button
                        onClick={() => onAddTitleSub("Text")}
                        className="btn-primarily btn-design-style flex-1 bg-[var(--bg-btn-func)] min-w-[9rem] h-[3.2rem] flex items-center justify-center gap-[.4rem] p-[.6rem] text-[#fff] rounded-[.4rem]"
                  >
                        <Type size={iconSize} />
                  ...
                  <button
                        ...
                        className="btn-primarily btn-design-style flex-1 bg-[var(--bg-btn-func)] min-w-[9rem] h-[3.2rem] flex items-center justify-center gap-[.4rem] text-[#fff]  rounded-[.4rem]"
                  >
                        <Type size={iconSize} />
