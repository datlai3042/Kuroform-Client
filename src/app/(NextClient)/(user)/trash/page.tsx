...
const TrashFormPage = () => {
      return (
            <div className="w-full min-h-screen flex flex-col bg-color-gap-empty ">
                  ...
                  <div className="flex-1 flex flex-col min-h-[60rem] h-full text-text-theme  ">
                        <h3 className="my-[2rem] pl-[2.8rem] !text-[2.3rem] text-[#fff]">Các form đang ở chế độ Delete</h3>
