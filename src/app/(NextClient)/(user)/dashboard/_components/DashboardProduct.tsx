...
const DashboardProduct = () => {
      ...
      return (
            <div className={` flex flex-col gap-[.6rem] text-text-theme `}>
                  ...
                  <Link href={"/notification"} className={`nav ${colorTheme} ${pathName === "/notification" ? "nav__isActive" : "nav__normal "}  `}>
                        <Bell size={18} />
                        <span className="font-medium ">Quản lí thông báo</span>
                  </Link>

                  <Link href={"/trash"} className={`nav ${colorTheme} ${pathName === "/trash" ? "nav__isActive" : "nav__normal "}  `}>
                        <Trash2 />
