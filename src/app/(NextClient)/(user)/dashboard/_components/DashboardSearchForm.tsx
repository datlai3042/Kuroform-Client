...
const DashboardSearchForm = ({ widthInput }: { widthInput?: string }) => {
      ...
      return (
            <div
                  ...
                  className=" z-[200] flex relative p-[.2rem_1rem] w-[13rem] xl:w-[20rem] h-[3.2rem]  rounded-lg focus-within:border-[.1rem] focus-within:border-color-main border-[.1rem] border-color-main  items-center gap-[.8rem]
"
            >
