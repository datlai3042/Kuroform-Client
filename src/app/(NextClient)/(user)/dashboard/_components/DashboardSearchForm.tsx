...
const DashboardSearchForm = () => {
	...
	return (
		<div
			className="relative p-[.2rem_1rem] h-[3.2rem]  rounded-lg focus-within:border-[.1rem] focus-within:border-color-main border-[.1rem] border-color-main flex items-center gap-[.8rem]
"
		>
			...
			{(openFormSearch || focusSearch) && (
				<ClickOutSide setOpenModel={setOpenFormSearch}>
					<div className="absolute bottom-[0rem] translate-y-[100%] left-0 w-full right-0 min-h-[4rem] max-h-[24rem] scroll-color-main  bg-[#fff] border-[.1rem] border-gray-300 rounded-lg h-max">
