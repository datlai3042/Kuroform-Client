...
const NotificationSystemItem = (props: TProps) => {
      ...
      return (
            <NotificationItemWrapper callbackDelete={onDeleteNotificationItem}>
                  <Image src={"/assets/images/icon/system.png"} width={50} height={50} alt="avatar form" className="min-w-[6rem] h-[6rem] rounded-full" />

                  <div className="w-[80%]  flex flex-col gap-[1rem] text-[1.4rem] leading-10">
                        <p className="text-left text-color-main font-extrabold">Thông báo hệ thống</p>
