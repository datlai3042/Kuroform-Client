...
const ButtonAddInput = (props: ButtonAddInputProps) => {
      ...
      return (
            <button
                  ...
                  } btn-primarily opacity-100 text-left mt-[1rem] min-w-[4rem] w-max px-[1rem] h-[3.6rem]  flex items-center justify-center bg-color-main  text-white rounded-[.4rem] text-[1.5rem] btn-func`}
            >
                  {textContent}
            </button>
      );
