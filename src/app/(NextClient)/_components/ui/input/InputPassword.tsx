...
const InputPassword = <FormType extends FieldValues>(
        ...
        <div className="flex flex-col gap-[.2rem]   w-full  ">
          {!unActiveLabel && (
            <label
              ...
              htmlFor={`${FieldKey}-${id}`}
              className="first-letter:uppercase text-color-main font-bold text-[1.6rem]"
            >
              {placeholder}
            </label>
          )}
          ...
          <div className="relative flex items-center w-full h-[60%]">
            <input
              ...
              className="inline-block w-full p-[.2rem] bg-transparent pr-[1.2rem] opacity-100 rounded-[.3rem] text-text-theme   text-[1.4rem]   font-semibold outline-transparent  placeholder:opacity-100 "
