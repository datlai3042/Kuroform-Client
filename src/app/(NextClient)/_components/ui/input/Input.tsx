  ...
  return (
    ...
    >
      <div className="flex items-center p-[.6rem_0rem]  w-full border-[.1rem]  border-border-page-color bg-transparent  h-max gap-[.6rem]  rounded-[.8rem] ">
        ...
        <div className="flex flex-col gap-[.2rem]   w-full">
          ...
          <input
            ...
            className="inline-block  input-form w-full  p-[.2rem] pr-[1.2rem] text-[1.4rem]  opacity-100 text-text-theme  font-semibold outline-transparent bg-transparent  placeholder:opacity-100 "
      ...
      {error && error[FieldKey]?.message && (
        <InputError message={input_erros as string}/>
      )}
