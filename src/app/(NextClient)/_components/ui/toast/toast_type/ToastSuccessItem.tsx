...
const ToastSuccessItem = (props: TProps) => {
	...
	return (
		<ToastWrapper toast_item_id={toast_item._id} indexItem={index}>
			<div className="relative min-h-[10rem] h-max p-[1rem] flex justify-between rounded-xl  bg-bg-input-theme text-color-section-theme text-[1.4rem]">
				<button
				...
				<div className="border-l-[.6rem] border-green-600 pl-[2rem] flex flex-col min-w-[70%] max-w-[80%] gap-[1rem] text-[#000]">
