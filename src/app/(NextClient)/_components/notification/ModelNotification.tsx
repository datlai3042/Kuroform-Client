...
const ModelNotification = () => {
	...
	return (
		<div className="bg-color-section-theme text-text-theme rounded-3xl w-full xl:w-[46rem]  text-[1.4rem] max-h-[50rem] flex flex-col gap-[1.4rem] min-h-[4rem] h-max p-[3rem]  shadow-xl">
