...
const ModelNotification = (props: TProps) => {
      ...
      return (
            <div onClick={(e) => e.stopPropagation()} className="bg-color-section-theme text-text-theme w-[90vw] xl:w-[70rem]  text-[1.4rem] max-h-screen flex flex-col gap-[3rem] min-h-screen h-max p-[3rem]  shadow-xl">
                  ...
                  <div onClick={(e) => e.stopPropagation()} className=" overflow-y-auto overflow-x-hidden pb-[1rem] pr-[2rem] flex flex-col gap-[1.5rem] ">
                        {notifications &&
