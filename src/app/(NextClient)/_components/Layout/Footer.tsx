...
const Footer = () => {
      return (
            <div className="fixed left-0 right-0 bottom-[-.4rem] border-t-[.1rem] border-[var(--border-color-input)]  h-[6rem] text-text-theme z-[997] bg-[var(--color-section-theme)] md:hidden flex items-center justify-between py-[1rem] px-[1.8rem]">
                  {/* <Link href={"/settings"}>
                        <Settings size={24} />
                  </Link> */}
