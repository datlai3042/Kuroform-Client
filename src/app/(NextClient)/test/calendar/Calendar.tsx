      ...
      return (
            ...
            >
                  ...
                  <div
                        ...
                        className="bg-[#fff] flex w-[23rem] xl:w-[44rem] flex-col p-[.8rem] xl:p-[2rem_2.4rem] border-[.1rem] border-[var(--border-color-input)] rounded-[.4rem] "
                  >
                        <div className="w-full flex xl:justify-center">
                              {name_in_week.map((day_name, i) => (
                                    <p className="w-[3.4rem] xl:w-[6rem] text-[#000] h-[3rem]  flex justify-center items-center" key={day_name + i}>
                              ...
                              {weekRender.map((week, i) => (
                                    <div key={week.week_count + "week_id" + i} className="flex">
                                          {week.week_menber.map((detail) => (
                                                ...
                                                >
                                                      <button
                                                            style={{ opacity: detail.state !== "current" ? ".7" : ".7" }}
                                                            onClick={(e) => {
                                                                  e.stopPropagation();
                  ...
                  className="flex bg-[#fff] rounded-lg  text-[1.2rem]  flex-col xl:flex-row xl:items-center justify-end gap-[2rem] xl:gap-0 p-[.8rem] xl:px-[1.4rem]">
