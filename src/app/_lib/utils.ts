...
export const stringToSlug = (str: string) => {
      // remove accents
      const from = regexSlugCharVNForm;
      const to = regexSlugCharVnTo;
...
export const filterTypeInput = <InputType extends InputCore.InputForm>(_id: string, inputItem: InputCore.InputForm): inputItem is InputType => {
